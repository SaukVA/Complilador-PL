...
static const char *const yytname[] =
{
  ...
  "Fun", "$@6", "@7", "@8", "A", "@9", "@10", "DV", "Tipo", "Cod", "@11",
  "I", "@12", "$@13", "@14", "@15", "@16", "Ip", "@17", "Expr", "E", "T",
  "F", YY_NULLPTR
};
#endif
...
{
     -61,    10,    -9,   -61,    12,   -61,    24,   -61,   -61,    25,
     -61,    21,   -61,    -9,    22,   -61,    16,   -61,   -61,   -61,
      -2,     8,   -61,   -61,   -61,   -61,   -61,    17,     8,   -61,
     -61,   -61,    13,     4,    -3,    -3,    33,     2,   -61,     8,
      32,    -3,   -61,   -61,   -61,   -61,    18,    29,   -61,    37,
      -3,   -61,   -61,   -61,   -61,    39,    -3,    -3,    -3,   -61,
     -61,     4,     4,   -61,    29,    34,   -61,     4,   -61,     6,
     -61,   -61,    11,   -61,   -61,   -61,     4,    26,   -61
};
...
{
       2,     0,     0,     1,     0,     3,     0,     4,     8,     6,
       5,     9,     7,     0,     0,    10,     0,    12,    13,    19,
       0,     0,    17,    14,    22,    23,    20,     0,     0,     8,
      21,    18,    15,    27,     0,     0,     0,     0,    26,     0,
       0,     0,    48,    46,    47,    36,    41,    43,    45,     0,
       0,    24,    16,    28,    30,     0,     0,     0,     0,    33,
      32,    27,    27,    49,    42,    40,    44,    27,    25,     0,
      34,    31,     0,    37,    39,    35,    27,     0,    38
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -61,   -61,   -61,    35,   -61,    20,   -61,   -61,   -61,   -61,
     -61,   -61,   -61,   -61,   -61,   -61,   -61,   -25,   -61,   -17,
     -61,   -60,   -61,   -61,   -61,   -61,   -61,   -61,   -61,   -33,
     -10,    -6,    -7
};
...
static const yytype_int8 yydefgoto[] =
{
      ...
      17,    19,    29,    33,    20,    28,    21,    26,    27,    37,
      61,    38,    39,    40,    62,    67,    72,    75,    76,    45,
      46,    47,    48
};
...
{
      41,    68,    49,    31,     4,    22,    23,    70,    55,    51,
       3,    52,   -29,    51,    53,    71,    77,    60,    42,    43,
      44,    34,    35,    24,    25,    36,    -6,    -6,    56,    57,
      73,    74,     7,     6,    10,   -11,    16,    18,    30,    50,
      54,    58,    59,    63,    56,    69,    78,    65,    15,    32,
      64,    66
};

static const yytype_uint8 yycheck[] =
{
       3,    61,    35,    28,    13,     7,     8,    67,    41,     7,
       0,     9,     8,     7,    39,     9,    76,    50,    21,    22,
      23,    17,    18,    15,    16,    21,    13,    14,    10,    11,
      19,    20,     8,    21,     9,    14,    14,    21,    21,     6,
       8,    12,     5,     4,    10,    62,    20,    57,    13,    29,
      56,    58
};
...
static const yytype_uint8 yystos[] =
{
       ...
       9,    30,    31,    32,    33,    27,    14,    34,    21,    35,
      38,    40,     7,     8,    15,    16,    41,    42,    39,    36,
      21,    41,    29,    37,    17,    18,    21,    43,    45,    46,
      47,     3,    21,    22,    23,    53,    54,    55,    56,    53,
       6,     7,     9,    41,     8,    53,    10,    11,    12,     5,
      53,    44,    48,     4,    55,    54,    56,    49,    45,    43,
      45,     9,    50,    19,    20,    51,    52,    45,    20
};
...
static const yytype_uint8 yyr1[] =
{
      ...
      31,    33,    31,    35,    36,    37,    34,    39,    38,    40,
      38,    41,    42,    42,    44,    43,    43,    46,    45,    47,
      48,    45,    45,    49,    50,    45,    45,    52,    51,    51,
...
#line 47 "plp4.y" /* yacc.c:1646  */
    { (yyval).th = ""; }
#line 1298 "plp4.tab.c" /* yacc.c:1646  */
    break;
...
#line 1308 "plp4.tab.c" /* yacc.c:1646  */
    break;
...
#line 55 "plp4.y" /* yacc.c:1646  */
    {
                        ...
                        (yyval).th = (yyvsp[-3]).th == "" ? lexema : (yyvsp[-3]).th + "_" + lexema;
                        struct Simbolo p1 = {lexema, CLASSFUN, (yyvsp[-3]).th + "_" + lexema};
                        if(!tsa->buscarAmbito(p1)){tsa->anyadir(p1);} 
                        else{errorSemantico(ERRYADECL, (yyvsp[-1]).lexema, (yyvsp[-1]).nlin, (yyvsp[-1]).ncol);}
...
#line 1332 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 71 "plp4.y" /* yacc.c:1646  */
    { (yyval).th = (yyvsp[-1]).th; }
#line 1338 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 71 "plp4.y" /* yacc.c:1646  */
    { (yyval).trad = (yyvsp[-2]).trad + (yyvsp[0]).trad;}
#line 1344 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 72 "plp4.y" /* yacc.c:1646  */
    { (yyval).trad = "";}
#line 1350 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 75 "plp4.y" /* yacc.c:1646  */
    { (yyval).th = (yyvsp[0]).th;}
...
#line 76 "plp4.y" /* yacc.c:1646  */
    { (yyval).th = (yyvsp[0]).th;}
#line 1368 "plp4.tab.c" /* yacc.c:1646  */
    break;
...
#line 1374 "plp4.tab.c" /* yacc.c:1646  */
  ...
  case 13:
#line 79 "plp4.y" /* yacc.c:1646  */
    {
                lexema = (yyvsp[0]).lexema;
                struct Simbolo p1 = {lexema, CLASSFUN, (yyvsp[-2]).th + "_" + lexema};
                if(!tsa->buscarAmbito(p1)){tsa->anyadir(p1);} 
                else{errorSemantico(ERRYADECL, (yyvsp[0]).lexema, (yyvsp[0]).nlin, (yyvsp[0]).ncol);}
                tsa = new TablaSimbolos(tsa);
              }
...
#line 85 "plp4.y" /* yacc.c:1646  */
    {lexema = (yyvsp[-3]).lexema; (yyval).th = (yyvsp[-5]).th + "_" + lexema;}
#line 1392 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 85 "plp4.y" /* yacc.c:1646  */
    {lexema = (yyvsp[-5]).lexema; (yyval).th = (yyvsp[-7]).th + "_" + lexema;}
...
#line 86 "plp4.y" /* yacc.c:1646  */
    {
                              lexema = (yyvsp[-8]).lexema;
                              (yyval).trad = "void " + (yyvsp[-10]).th + "_" + lexema + "(" + (yyvsp[-6]).trad + "){\n" + (yyvsp[-3]).trad + (yyvsp[-1]).trad + "\n} // " + (yyvsp[-10]).th + "_" + lexema + "\n";
                              tsa = tsa->padre;
                            }
...
#line 92 "plp4.y" /* yacc.c:1646  */
    { (yyval).th = ""; }
#line 1414 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 18:
#line 92 "plp4.y" /* yacc.c:1646  */
    {(yyval).trad = (yyvsp[-3]).trad + "," + (yyvsp[0]).trad;}
#line 1420 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 93 "plp4.y" /* yacc.c:1646  */
    { (yyval).th = ""; }
#line 1426 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 20:
#line 93 "plp4.y" /* yacc.c:1646  */
    { (yyval).trad = (yyvsp[0]).trad; }
#line 1432 "plp4.tab.c" /* yacc.c:1646  */
    break;
...
#line 97 "plp4.y" /* yacc.c:1646  */
    {
                              ...
                              if((yyvsp[-2]).th == ""){
                                struct Simbolo p1 = {lexema, (yyvsp[-1]).tipo, lexema};
                                if(p2 == NULL || !tsa->buscarAmbito(p1)){tsa->anyadir(p1);}
                                else{errorSemantico(ERRYADECL, (yyvsp[0]).lexema, (yyvsp[0]).nlin, (yyvsp[0]).ncol);}
                                (yyval).trad = (yyvsp[-1]).trad + (yyvsp[0]).lexema;
                              }
                              else{
                                struct Simbolo p1 = {lexema, (yyvsp[-1]).tipo, (yyvsp[-2]).th + lexema};
                                if(p2 == NULL || !tsa->buscarAmbito(p1)){tsa->anyadir(p1);}
                                else{errorSemantico(ERRYADECL, (yyvsp[0]).lexema, (yyvsp[0]).nlin, (yyvsp[0]).ncol);}
                                (yyval).trad = (yyvsp[-1]).trad + (yyvsp[-2]).th + (yyvsp[0]).lexema + ";";
                              }
                            }
#line 1454 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 22:
#line 116 "plp4.y" /* yacc.c:1646  */
    { (yyval).trad = "int "; (yyval).tipo = ENTERO;}
#line 1460 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 23:
#line 117 "plp4.y" /* yacc.c:1646  */
    { (yyval).trad = "float "; (yyval).tipo = REAL;}
#line 1466 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 24:
#line 120 "plp4.y" /* yacc.c:1646  */
    {(yyval).th = (yyvsp[-2]).th;}
#line 1472 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 25:
#line 120 "plp4.y" /* yacc.c:1646  */
    { (yyval).trad = (yyvsp[-3]).trad + "\n" + (yyvsp[0]).trad; }
#line 1478 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 26:
#line 121 "plp4.y" /* yacc.c:1646  */
    { (yyval).trad = (yyvsp[0]).trad; }
#line 1484 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 27:
#line 124 "plp4.y" /* yacc.c:1646  */
    {(yyval).th = (yyvsp[0]).th + "_";}
#line 1490 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 28:
#line 124 "plp4.y" /* yacc.c:1646  */
    { (yyval).trad = (yyvsp[0]).trad; }
#line 1496 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 29:
#line 125 "plp4.y" /* yacc.c:1646  */
    {tsa = new TablaSimbolos(tsa);}
#line 1502 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 30:
#line 125 "plp4.y" /* yacc.c:1646  */
    { (yyval).th = (yyvsp[-2]).th + "_";}
#line 1508 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 31:
#line 125 "plp4.y" /* yacc.c:1646  */
    { (yyval).trad = "{\n" + (yyvsp[-1]).trad + "\n}"; tsa = tsa->padre;}
#line 1514 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 32:
#line 127 "plp4.y" /* yacc.c:1646  */
    {
                              struct Simbolo* p1 = tsa->buscar((yyvsp[-2]).lexema);
                              if( p1 != NULL) {
                                if(p1->tipo == (yyvsp[0]).tipo){ (yyval).trad = p1->nomtrad + " = " + (yyvsp[0]).trad + ";"; }
                                else if(p1->tipo == REAL && (yyvsp[0]).tipo == ENTERO){ (yyval).trad = p1->nomtrad + " = itor( " + (yyvsp[0]).trad + ");"; }
                                else {errorSemantico(ERRTIPOS, (yyvsp[-1]).lexema, (yyvsp[-1]).nlin, (yyvsp[-1]).ncol);}
                              }
                              else{errorSemantico(ERRNODECL, (yyvsp[-2]).lexema, (yyvsp[-2]).nlin, (yyvsp[-2]).ncol);}
                            }
#line 1528 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 33:
#line 136 "plp4.y" /* yacc.c:1646  */
    { (yyval).th = (yyvsp[-3]).th; }
#line 1534 "plp4.tab.c" /* yacc.c:1646  */
    break;

  case 34:
#line 136 "plp4.y" /* yacc.c:1646  */
    { (yyval).th = (yyvsp[-5]).th; }
#line 1540 "plp4.tab.c" /* yacc.c:1646  */
    break;
...
#line 153 "plp4.y" /* yacc.c:1646  */
    {
                            ...
                            if((yyvsp[-2]).tipo == ENTERO){
                                if((yyvsp[0]).tipo == ENTERO){ (yyval).trad = (yyvsp[-2]).trad + " " + lexema + "i " + (yyvsp[0]).trad; (yyval).tipo = ENTERO; }
                                else{(yyval).trad = "itor(" + (yyvsp[-2]).trad + ") " + lexema + "r " + (yyvsp[0]).trad; (yyval).tipo = ENTERO; }
                            }
                            else{
                                if((yyvsp[0]).tipo == ENTERO){ (yyval).trad = (yyvsp[-2]).trad + " " + lexema + "r itor(" + (yyvsp[0]).trad + ")"; (yyval).tipo = ENTERO; }
...
#line 168 "plp4.y" /* yacc.c:1646  */
    {
                            ...
                            if((yyvsp[-2]).tipo == ENTERO){
                                if((yyvsp[0]).tipo == ENTERO){ (yyval).trad = (yyvsp[-2]).trad + " " + lexema + "i " + (yyvsp[0]).trad; (yyval).tipo = ENTERO; }
                                else{(yyval).trad = "itor(" + (yyvsp[-2]).trad + ") " + lexema + "r " + (yyvsp[0]).trad; (yyval).tipo = REAL; }
                            }
                            else{
                                if((yyvsp[0]).tipo == ENTERO){ (yyval).trad = (yyvsp[-2]).trad + " " + lexema + "r itor(" + (yyvsp[0]).trad + ")"; (yyval).tipo = REAL; }
